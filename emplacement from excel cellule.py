# -*- coding: utf-8 -*-
"""
Created on Thu Dec 11 13:12:18 2025
...
file_path=r"C:\Users\User\Downloads\26650 mal cyclées.xlsx"
...
for num_serie in list_num_serie:
    requete = """
        SELECT numero_serie, code_emplacement
        FROM emplacement
    ...
    for (num_serie,code_emplacement) in resultats:
        data.append([
            num_serie,
            code_emplacement
